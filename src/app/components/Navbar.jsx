...
//         {/* Mobile Menu */}
//         {mobileMenuOpen && (
//           <div className="absolute top-full left-0 w-full bg-white shadow-lg py-4 lg:hidden z-50">
...
//                   <h4 className="font-semibold text-base sm:text-lg text-white">{service.title}</h4>
